...
def test_function_speed(func, func2, *args, **kwargs):
    ...
    for i in range(5):
        ...
        (encryptedMsg,privKey)=func(*args, **kwargs)
        end_time = time.perf_counter()
        times.append(end_time - start_time)
        print("done ecyrpt")
        start_time_decrypt = time.perf_counter()
        decryptedMsg=func2(encryptedMsg, privKey, **kwargs)
...
def encrypt_decrypt_ECC(msg):
    ...
    def encrypt_ECC(msg, pubKey):
        ...
        #ciphertextPubKeyGlobal = ciphertextPubKey
    ...
    return (encryptedMsgObj, privKey)
